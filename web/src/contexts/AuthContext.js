...
import {mbgApi} from "../components/lib/mbg-api";
import { TOKEN_STORAGE_KEY, USER_STORAGE_KEY } from "../components/constants/mbg";
...
export function AuthProvider({ children }) {
  ...
  useEffect(() => {
    ...
    window.addEventListener("mbg:unauthorized", handleUnauthorized);
    return () => window.removeEventListener("mbg:unauthorized", handleUnauthorized);
  }, []);
