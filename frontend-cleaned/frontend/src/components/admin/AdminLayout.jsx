    ...
    <div className="flex h-screen bg-gray-50 text-slate-900">
      ...
      >
        ...
        <div className="p-3 border-t border-slate-100">
          <div className="rounded-lg bg-gradient-to-br from-emerald-50 to-slate-50 p-3 border border-emerald-100">
            <div className="text-[10px] text-emerald-700 uppercase tracking-widest font-semibold mb-0.5">
              💡 Tahukah Anda
            </div>
            <div className="text-[11px] text-slate-600 leading-snug">
              Menu Planner adalah modul transaksi utama. Mulai dari sini.
            </div>
          </div>
        </div>
      </aside>
