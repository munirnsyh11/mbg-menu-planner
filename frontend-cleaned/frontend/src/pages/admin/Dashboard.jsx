  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto" data-testid="dashboard-page">
      ...
      <div className="text-center text-xs text-slate-400 pt-4">
        Dashboard ini hanya menampilkan ringkasan. Operasional perencanaan menu ada di <Link to="/admin/menus" className="text-emerald-600 font-medium hover:underline">Menu Planner</Link>.
      </div>
    </div>
  );
}
